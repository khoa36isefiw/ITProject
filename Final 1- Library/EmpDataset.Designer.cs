...
namespace Final_1__Library.EmpDatasetTableAdapters {
...
SELECT ID_Employee, Name, Gender, CCCD, Phone, Address, Position, Salary, Working_time, Extra FROM EMPLOYEES WHERE (ID_Employee = @ID_Employee)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ID_Employee, Name, Gender, CCCD, Phone, Address, Position, Salary, Working" +
                "_time, Extra\r\nFROM     EMPLOYEES\r\nWHERE  (Working_time >= 300)";
        ...
        public virtual int FillBy(EmpDataset.EMPLOYEESDataTable dataTable) {
        ...
        public virtual EmpDataset.EMPLOYEESDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            EmpDataset.EMPLOYEESDataTable dataTable = new EmpDataset.EMPLOYEESDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
