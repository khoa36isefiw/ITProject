...
namespace Final_1__Library.CLASSES
{
    internal class BL_Book
    {
        public DataTable Take_Book()
        {
            ...
            {
                dt.Rows.Add(p.ID_Book, p.Name, p.ID_publisher, p.ID_author,p.Type,p.Description,p.Update_day,p.N_books,p.price);
            }
            return dt;
        }
        ...
        public bool Add_Book(int id, string name, int id_Publisher, int id_Author,string type,string decription,DateTime updateday,int nbook , int price)
        {
            QuanLyThuVienEntities qltvEntity = new QuanLyThuVienEntities();
        ...
        public bool Edit_Book(int id, string name, int id_Publisher, int id_Author, string type, string decription, DateTime updateday, int nbook, int price)
        {
            QuanLyThuVienEntities qltvEntity = new QuanLyThuVienEntities();
            var tpQuery = (from p in qltvEntity.BOOKS
                           where p.ID_Book == id
