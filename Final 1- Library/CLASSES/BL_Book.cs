...
namespace Final_1__Library.CLASSES
{
    internal class BL_Book
    {
        ...
        //    return returnImage;
        //}
        public bool Add_Book(int id, string name, int id_Publisher, int id_Author,string type,string decription,DateTime updateday,int nbook , int price, byte[] picture)
        {
            library1010Entities2 qltvEntity = new library1010Entities2();
        ...
        //{
        //    library1010Entities2 library1010Entities2 = new library1010Entities2();
        //    return library1010Entities2.BOOKS.ToList();
        //}
