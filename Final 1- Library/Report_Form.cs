...
namespace Final_1__Library
{
    public partial class Report_Form : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'dS_Borrowed_Book.Borrow_Book' table. You can move, or remove it, as needed.
            this.borrow_BookTableAdapter.Fill(this.dS_Borrowed_Book.Borrow_Book);
            ...
            //this.borrow_BookTableAdapter.Fill();
            //this.borrow_BookTableAdapter.Fill(this.dS_Borrowed_Book.Borrow_Book);
